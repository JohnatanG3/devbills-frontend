	...
	return (
		<div className="bg-gray-950 min-h-screen">
			<div className="container-app">
				...
				<section className="py-12 md:py-20 bg-gray-900 border border-gray-700 rounded-xl">
					<div className="container-app">
				...
				<section className="py-12 md:py-20">
					<div className="bg-gray-900 p-8 md:p-12 rounded-xl text-center border border-gray-700">
						...
						<p className="text-white text-center opacity-90 max-w-2xl mx-auto mb-8">
			...
			<footer className="border-t border-gray-700 py-6 mt-12 text-center">
